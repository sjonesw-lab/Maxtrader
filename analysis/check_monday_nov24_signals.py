"""
Quick analysis: What signals were available on Monday, Nov 24, 2025
...
def main():
    print("\n" + "="*80)
    print("MONDAY, NOVEMBER 24, 2025 - SIGNAL ANALYSIS")
    print("="*80 + "\n")
    ...
    if df is None or len(df) == 0:
        print("❌ No data available for Monday, Nov 24, 2024")
        print("   Trying 2025...")
        df = fetcher.fetch_stock_bars(
            ticker='QQQ',
    ...
    if df is None or len(df) == 0:
        print("❌ No data available for Monday, Nov 24, 2025")
        return
    ...
    if len(relax_signals) > len(prod_signals):
        ...
        print(f"\n✅ Both configurations correctly identified this as a NO-TRADE day")
    else:
